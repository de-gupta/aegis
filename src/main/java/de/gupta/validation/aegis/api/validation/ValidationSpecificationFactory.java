...
import de.gupta.validation.aegis.api.validation.collection.NotEmptySpecification;
import de.gupta.validation.aegis.api.validation.comparison.ComparisonSpecification;
import de.gupta.validation.aegis.api.validation.custom.CustomCheckSpecification;
import de.gupta.validation.aegis.api.validation.number.*;
import de.gupta.validation.aegis.api.validation.object.ConsistencySpecification;
...
//		return ComparisonSpecification.of(extractor, thresholdExtractor, comparisonType, exceptionSupplier);
	...
	public static <T, V extends ValidationFailedException> Validation<T> timeSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> timeSpecificationLocalDate(
	...
	public static <T, V extends ValidationFailedException> Validation<T> timeComparisonSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> ageSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> negativeSpecification(
	...
	public static <T> Validation<T> notNullNotBlankNoLeadingOrTrailingSpacesSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> notNullSpecification(
			final Function<T, ?> extractor, final Supplier<V> exceptionSupplier)
	{
		return NotNullSpecification.of(extractor, exceptionSupplier);
	}

	public static <T, V extends ValidationFailedException> Validation<T> notBlankSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> noLeadingOrTrailingSpacesSpecification(
			final Function<T, String> extractor, final Supplier<V> exceptionSupplier)
	{
		return NoLeadingOrTrailingSpacesSpecification.of(extractor, exceptionSupplier);
	}

	public static <T, V extends ValidationFailedException> Validation<T> mapNotEmptySpecification(
	...
	public static <T> Validation<T> nullOrNotBlankAndNoLeadingOrTrailingSpacesSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> collectionNotEmptySpecification(
	...
	public static <T, W, V extends ValidationFailedException> Validation<T> inCollectionSpecification(
	...
	public static <T, W, V extends ValidationFailedException> Validation<T> eachInCollectionSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> greaterThanSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> lessThanSpecification(
			final Function<T, ? extends Number> extractor, final Number threshold, final Supplier<V> exceptionSupplier)
	{
		return LessThanSpecification.of(extractor, threshold, exceptionSupplier);
	}

	public static <T, V extends ValidationFailedException> Validation<T> eachGreaterThanSpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> eachGreaterThanOrEqualToSpecification(
			final Function<T, ? extends Collection<Number>> extractor,
			final Number threshold, final Supplier<V> exceptionSupplier)
	{
	...
	public static <T, V extends ValidationFailedException> Validation<T> eachLessThanSpecification(
			final Function<T, ? extends Collection<Number>> extractor,
			final Number threshold, final Supplier<V> exceptionSupplier)
	{
	...
	public static <T, V extends ValidationFailedException> Validation<T> consistencySpecification(
	...
	public static <T, V extends ValidationFailedException> Validation<T> customCheckSpecification(
